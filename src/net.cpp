...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("AndromedaCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("AndromedaCoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("AndromedaCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "AndromedaCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("AndromedaCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("AndromedaCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("AndromedaCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("AndromedaCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. AndromedaCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("AndromedaCoin-start");
