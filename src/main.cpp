...
const string strMessageMagic = "AndromedaCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "AndromedaCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Thu, 18 Feb 2016 16:52:41 GMT";
        CTransaction txNew;
        txNew.nTime = 1455814361;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1455814367;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3747519;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x77eeddeaad484d9a6a30fdb09390bbb38f3b70c11d03299549cedb39d257ea31"));
        block.print();
